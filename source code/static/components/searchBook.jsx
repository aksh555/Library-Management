 ...
 render(){
   ...
   return <div className='searchBook'>
    ...
    <div className={"input-group "+bookSearchClassName}>
     <input type="text" className="form-control" placeholder="Enter Book title/Author name/ISBN code to search.." name='searchBook' ref={(input)=>{this.searchInput=input}} onKeyPress = {this.handleSearch} / >
